...
Builds a
[TaskLCE](https://mlr-org.github.io/celecx/reference/TaskLCE.md) whose
target is the best objective value observed up to (and including) each
archive batch – the progress curve of an optimization run. This is the
optimization-mode counterpart of the surrogate-performance tasks built
by
...
- link:
  ...
  [lce_link](https://mlr-org.github.io/celecx/reference/lce_link.md) for
  the resulting task. `"identity"` by default; note that objective
