...
[TaskLCE](https://mlr-org.github.io/celecx/reference/TaskLCE.md), the
same shape produced online by
...
- pool:
  ...
  resulting
  [TaskLCE](https://mlr-org.github.io/celecx/reference/TaskLCE.md) for
  pool-based replay. Its columns must be the archive's search-space ids.
  `NULL` (default) for continuous runs.
